    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center space-y-8 bg-gradient-to-br from-[#0c1023] to-[#1a0b2e]">
        <div className="relative">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-[#5d2595] via-[#9b4dff] to-[#5d2595] bg-clip-text text-transparent animate-gradient">
            RoxShield
          </h1>
          <div className="absolute -bottom-3 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-[#5d2595] to-transparent animate-pulse" />
        </div>
