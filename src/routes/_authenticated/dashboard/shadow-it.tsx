...
export const Route = createFileRoute("/_authenticated/dashboard/shadow-it")({
  component: ShadowItPage,
});

function ShadowItPage() {
  return (
    <>
      <DashboardTopbar
        title="Shadow IT"
        description="Détection et gestion du Shadow IT"
      />
