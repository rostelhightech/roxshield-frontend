...
export function FormationProgressComponent({ progress }: FormationProgressProps) {
  ...
  return (
    <Card className="rounded-md border border-white/10 bg-[#0c1023]/90 shadow-xl">
      <CardHeader>
        <CardTitle className="text-white">Progression des utilisateurs</CardTitle>
      </CardHeader>
      <CardContent>
        {progress.length === 0 ? (
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm">{userProgress.userEmail}</p>
                    {userProgress.userPosition && (
                      <p className="text-gray-500 text-xs">{userProgress.userPosition}</p>
                    )}
                  </div>
                </div>
