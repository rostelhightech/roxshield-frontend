    ...
    return (
      <Card className="rounded-sm border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0c1023]/90">
        <CardContent className="p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Aucun contenu</h3>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-1">
        <Card className="rounded-sm border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0c1023]/90 sticky top-6">
          <CardHeader>
            <CardTitle className="text-gray-900 dark:text-white">Structure de la formation</CardTitle>
          </CardHeader>
                ...
                {selectedChapter.id === 'final-evaluation' && selectedChapter.evaluation ? (
                  <div className="space-y-6">
                    ...
                    {selectedChapter.evaluation.description && (
                      <div>
                        <h4 className="text-gray-500 dark:text-gray-400 text-sm font-medium mb-2">Description</h4>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gray-100 dark:bg-slate-800/50 rounded-lg p-4">
                        <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">Score requis</div>
                        <div className="text-gray-900 dark:text-white text-2xl font-bold">{selectedChapter.evaluation.passingScore}%</div>
                      </div>
                      <div className="bg-gray-100 dark:bg-slate-800/50 rounded-lg p-4">
                        <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">Temps limite</div>
                      ...
                      <div className="bg-gray-100 dark:bg-slate-800/50 rounded-lg p-4">
                        <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">Tentatives max</div>
                        <div className="text-gray-900 dark:text-white text-2xl font-bold">{selectedChapter.evaluation.maxAttempts}</div>
                      </div>
                      <div className="bg-gray-100 dark:bg-slate-800/50 rounded-lg p-4">
                        <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">Nombre de questions</div>
                    ...
                    {/* Liste des questions */}
                    <div>
                      <h4 className="text-gray-500 dark:text-gray-400 text-sm font-medium mb-3">Questions de l'évaluation</h4>
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 space-y-2">
                                ...
                                <div className="flex items-center gap-3 text-xs">
                                  ...
                                  <span className="text-gray-500 dark:text-gray-400">{question.points} point{question.points > 1 ? 's' : ''}</span>
                                </div>
                  ...
                  <>
                    ...
                    <div>
                      <h4 className="text-gray-500 dark:text-gray-400 text-sm font-medium mb-3">Contenu</h4>
                      <BlockNoteEditor
