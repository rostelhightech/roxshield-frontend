...
export const PlanCard = ({ plan, onEdit, onDelete }: PlanCardProps) => {
  ...
  return (
    <Card className={`bg-gray-900 border ${getPlanColor()} hover:border-gray-600 transition-all duration-300 overflow-hidden relative`}>
      {plan.isPopular && (
        <div className="absolute top-0 right-0">
          <div className="bg-yellow-600 text-yellow-100 text-xs font-semibold px-3 py-1 rounded-bl-lg flex items-center gap-1">
      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-gray-800 border-gray-700">
              <DropdownMenuItem onClick={() => onEdit(plan)} className="text-gray-300 hover:text-white">
                <Edit className="w-4 h-4 mr-2" />
                Modifier
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => onDelete(plan.id)} className="text-red-400 hover:text-red-300">
        ...
        <div className="mb-4">
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-gray-400 text-sm ml-1">/utilisateur</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <p className="text-sm font-semibold text-white mb-2">Fonctionnalités incluses :</p>
