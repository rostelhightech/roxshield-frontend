...
const plans = [
  {
    ...
    minUsers: 10,
    price_monthly_fcfa: 1500,
    price_yearly_fcfa: 15000,
    price_monthly_usd: 2.50,
    price_yearly_usd: 25,
    icon: Users,
    color: "from-rht-violet to-rht-violet-light",
    features: [
      {
        fr: "Formations de base (phishing, mots de passe, ingenierie sociale)",
        en: "Basic training (phishing, passwords, social engineering)",
      },
      {
        fr: "Simulations phishing illimitees",
        en: "Unlimited phishing simulations",
      },
      {
        fr: "Dashboard admin avec score de risque",
        en: "Admin dashboard with risk score",
      },
      {
        fr: "Rapport mensuel automatique",
        en: "Automatic monthly report",
      },
  ...
  },
  {
    ...
    minUsers: 20,
    price_monthly_fcfa: 2000,
    price_yearly_fcfa: 20000,
    price_monthly_usd: 3.30,
    price_yearly_usd: 33,
    icon: Building2,
    ...
    features: [
      ...
      {
        fr: "IA de detection des profils a risque",
        en: "AI risk profile detection",
      },
      {
        fr: "Simulations avancees (spear phishing, vishing)",
        en: "Advanced simulations (spear phishing, vishing)",
      },
      {
        fr: "Rapport hebdomadaire automatique",
        en: "Automatic weekly report",
      },
      {
        fr: "Dashboard analytics avance",
  ...
  },
  {
    ...
    features: [
      ...
      {
        fr: "Multi-organisations (holding, filiales)",
        en: "Multi-org (holding, subsidiaries)",
      },
      {
        fr: "API & integrations personnalisees",
      ...
      { fr: "Onboarding assiste", en: "Assisted onboarding" },
    ],
    highlighted: false,
  ...
  },
  {
    ...
    minUsers: 50,
    price_monthly_fcfa: 500,
    price_yearly_fcfa: 5000,
    price_monthly_usd: 0.85,
    price_yearly_usd: 8.50,
    icon: GraduationCap,
          ...
          <FadeIn>
            ...
            <div className="mt-8 grid gap-4 text-sm sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { fr: "Mises a jour incluses", en: "Updates included" },
